...
function sidebar_banner( $atts ) {
   ...
   <div class="SidebarBanner">
	<div class="SidebarBanner__inn">
	  ...
	  <a class="Button Button--full pt-s pb-s" href="<?= esc_url( isset( $atts['chatbotType'] ) ? 'https://api.urlslab.com/v1/auth/signin/google' : 'https://wordpress.org/plugins/urlslab/' ); ?>" target="_blank"><?= esc_html( isset( $atts['chatbotType'] ) ? __( 'Configure chatbot', 'urlslab' ) : __( 'Download plugin', 'urlslab' ) ); ?></a>
	</div>
	<img
