...
<div id="blog" class="Blog" itemscope itemtype="http://schema.org/Blog">
	...
	<div class="ArchiveTopSlider slider splide">
		...
		<div class="splide__track">
			<ul class="splide__list">
				...
				while ( $show_top_posts->have_posts() ) :
					...
					?>
					<li class="ArchiveTopSlider__slide splide__slide" itemprop="blogPost" itemscope itemtype="http://schema.org/BlogPosting">
						<a href="<?php the_permalink(); ?>" title="<?php the_title(); ?>" class="ArchiveTopSlider__inn slide__inn" itemprop="url">
							<div class="ArchiveTopSlider__inn--main">
								<div class="ArchiveTopSlider__image">
	...
	<div class="Blog__container wrapper">
		<ul class="Blog__items Archive__columns">
			<?php
			global $wp_query;
			...
			while ( $show_other_posts->have_posts() ) :
				...
				?>
				<li itemprop="blogPost" itemscope itemtype="http://schema.org/BlogPosting" <?php post_class( 'Blog__item col col-3 Box--shadow Box--article' ); ?>>
					<a href="<?php the_permalink(); ?>" title="<?php the_title(); ?>" itemprop="url">
						...
						<div class="Box__content Box--article__text">
							<div class="Blog__item__meta Blog__item__meta-flat">
								...
								<div class="Blog__item__meta__date">
									<svg viewBox="0 0 11 12" xmlns="http://www.w3.org/2000/svg"><path d="M8.556 5.4H2.444v1.2h6.112V5.4zm1.222-4.2h-.611V0H7.944v1.2H3.056V0H1.833v1.2h-.61c-.68 0-1.217.54-1.217 1.2L0 10.8c0 .66.544 1.2 1.222 1.2h8.556C10.45 12 11 11.46 11 10.8V2.4c0-.66-.55-1.2-1.222-1.2zm0 9.6H1.222V4.2h8.556v6.6zm-3.056-3H2.444V9h4.278V7.8z"/></svg>
									<span itemprop="datePublished" content="<?= esc_attr( get_the_time( 'Y-m-d' ) ); ?>">
										<?php the_time( 'F j, Y' ); ?>
									</span>
								</div>
							</div>
							<h3 class="Box--article__title" itemprop="name">
								<?php the_title(); ?>
							</h3>
							<p class="Box--article__excerpt" itemprop="abstract"><?= esc_html( wp_trim_words( get_the_excerpt(), 15 ) ); ?></p>
						</div>
					</a>
				</li>
			<?php endwhile; ?>
